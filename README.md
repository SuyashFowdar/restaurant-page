...
![Screenshot of the Book Library](./assets/Screenshot.png)

## Description

A simple JS Project for a Restaurant Page using Webpack.

## Setup
- Clone the project by running `git clone https://github.com/krishnzzz/restaurant-page.git` on terminal or CMD
...
https://krishnzzz.github.io/restaurant-page/
